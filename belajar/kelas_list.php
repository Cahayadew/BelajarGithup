	...
	<div class="portfolios" id="portfolio">
		<div class="container">
			...
			<ul id="filters" class="clearfix">
						...
						<a href="kelas_list.php"><li><span class="filter active">Lihat List Kelas</span></li></a>
					</ul>
                            ...
                            <?php
                                ...
                                while($dataku = mysql_fetch_object($daftar))
                                {
									...
									<tr>
										...
										<td align="center" style="vertical-align:middle"><?php echo $dataku->id_kelas; ?></td>
										<td style="vertical-align:middle"><?php echo $dataku->nama_kelas; ?></td>
										<td align="center" style="vertical-align:middle"><?php echo $dataku->jenjang_kelas; ?></td>
										<td align="center" style="vertical-align:middle"><?php echo $dataku->tingkat_kelas; ?></td>
										<td align="center" style="vertical-align:middle"><?php echo $dataku->jurusan_kelas; ?></td>
										<td style="vertical-align:middle"><?php echo $dataku->paket_kelas; ?></td>
										<td align="center" style="vertical-align:middle"><?php echo $dataku->kapasitas_kelas; ?></td>
