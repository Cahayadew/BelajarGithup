...
<body class="login">
	...
	<div class="content">
		<!-- BEGIN LOGIN FORM -->
		<form class="form-vertical login-form" action="login_proses.php" method="get">
			...
			<div class="forget-password">
				...
				<p>
					Don't worries, click <a href="javascript:;"  id="forget-password">here</a>
		...
		<form class="form-vertical forget-form" action="login_form.php" method="post">
			...
			<div class="control-group">
				<div class="controls">
					<div class="input-icon left">
						...
						<input class="m-wrap placeholder-no-fix" type="email" placeholder="Email" autocomplete="off" name="email" />
					</div>
				</div>
			</div>
			<div class="form-actions">
